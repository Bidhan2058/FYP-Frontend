...
import 'package:flutter_login_signup/src/components/listedVehicles.dart';
...
class SettingsTwoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(228, 100, 136, 245),
        elevation: 0,
      ),
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => ListedVehicles()));
                },
              ),
            ),
            Card(
